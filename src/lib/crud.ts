...
export const RESOURCES: Record<string, Resource> = {
  ...
  items: {
    ...
    fields: [
      ...
      { name: "reorderPoint", label: "จุดสั่งซื้อขั้นต่ำ", type: "number", step: "1", format: "num", span: 1, help: "คงเหลือต่ำกว่านี้จะขึ้นเตือนให้สั่งซื้อ" },
      { name: "note", label: "หมายเหตุ", type: "text", span: 4, hideInTable: true },
    ],
  },
  ...
  "stock-in": {
    ...
    fields: [
      ...
      { name: "qty", label: "จำนวนที่รับเข้า", type: "number", required: true, step: "1", format: "num", span: 1 },
      { name: "unitCost", label: "ราคาต่อหน่วย (บาท)", type: "number", step: "1", format: "money", span: 1 },
  ...
  "stock-out": {
    ...
    fields: [
      ...
      { name: "itemCode", label: "สินค้า", type: "select", required: true, options: { kind: "items" }, span: 2 },
      { name: "qty", label: "จำนวนที่เบิก", type: "number", required: true, step: "1", format: "num", span: 1 },
      ...
      { name: "cost", label: "มูลค่าที่เบิก (บาท)", type: "number", step: "1", format: "money", span: 1, help: "เว้นว่างเพื่อให้คิดจากราคาทุนล่าสุด × จำนวน" },
