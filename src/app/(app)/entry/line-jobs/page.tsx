...
export default async function LineJobsPage() {
  ...
  return (
    <>
      ...
      <Formula>
        ขั้นตอน: ออฟฟิศกรอกงานในชีต → ไลน์บอทแจ้งคนขับล่วงหน้า 17:00 น. (เก็บตก 18:00 น.) → คนขับส่งรูปตั๋ว ระบบอ่านตัวเลขให้ →
        ...
        <br />
        <b>รหัสงานห้ามซ้ำ</b> — 1 รหัส = 1 ขา ถ้าชีตมีหลายแถวใช้รหัสเดียวกัน ระบบจะไม่นำเข้าเลยสักแถว
        และเขียนเตือนกลับลงชีตว่าซ้ำแถวไหนบ้าง (เมื่อก่อนแถวที่เกินจะหายไปเงียบๆ จนวางบิลไม่ครบ)
      </Formula>
