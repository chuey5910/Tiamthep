...
echo
echo "─────────────────────────────────────────────"
echo "  ⚠ ข้างล่างนี้จะแสดงชื่อผู้ใช้และรหัสผ่านของ"
echo "  ผู้ดูแลระบบคนแรก — จดเก็บไว้ให้ดี แสดงครั้งเดียว"
echo "─────────────────────────────────────────────"
echo
npm run setup
echo
...
echo
echo "  อย่าลืม: เข้าระบบด้วยบัญชีผู้ดูแลข้างบน"
echo "  แล้วเปลี่ยนรหัสผ่านทันที"
echo "═════════════════════════════════════════════"
echo
